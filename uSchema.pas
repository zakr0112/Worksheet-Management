...
const
  SQL_SCHEMA: string =
    '''
      ...
      INSERT INTO reportconfig (id, headername, headertelephone, headeremail, csstheme) VALUES
        (1, 'Your Company Here', 'Tagline1 or Telephone', 'Tagline2 or Email', 'wtOriginal');
