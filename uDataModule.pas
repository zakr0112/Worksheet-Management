      ...
      SQL_JOBSMASTER: string =
       '''
          ...
          CREATE TABLE jobs_expenses (
            ...
            exdate REAL NOT NULL,
            exdetails TEXT NOT NULL,
            excost REAL NOT NULL,
            lastchanged REAL NOT NULL,
          ...
          VALUES
          ('MAINTENANCE',        45930.0, 'Oakridge Solutions Ltd',  '12 Elm Street, Manchester',                    'M1 2AB',  'info@oakridge.co.uk',               '0161 555 1234', 'C001', 'CN1001', 'Annual service',                    'Boiler serviced and tested',                         'None',                      'N/A',      'James Carter',  'Sarah Bennett',  'Sarah Bennett', '', 45930.395833),
          ('Electrical Repair',  45931.0, 'Brightwave Media',        '45 King''s Road, Brighton',                    'BN1 3XY', 'hello@brightwave.co.uk',            '01273 555 6789','C002', 'CN1002', 'Power outage',                      'Replaced fuse board',                                'Check wiring in 6 months',  'N/A',      'Emily Watson',  'Tom Harris',     'James Carter',  '', 45931.593750),
          ('Plumbing Callout',   45932.0, 'Nimbus Technologies',     '88 Cloud Lane, Leeds',                         'LS2 8PL', 'support@nimbus-tech.co.uk',         '0113 555 2468', 'C003', 'CN1003', 'Leak reported',                     'Pipe replaced under sink',                           'Monitor for leaks',         'N/A',      'Oliver Scott',  'Rachel Moore',   '',              '', 45932.489583),
          ('PAT Testing',        45933.0, 'Greenfield Logistics',    'Unit 4, Parkside Industrial Estate, Bristol',  'BS5 9TR', 'contact@greenfieldlogistics.co.uk', '0117 555 3344', 'C004', 'CN1004', 'Annual compliance check',           'Tested 50 portable appliances, all passed',          'None',                      'N/A',      'Laura Green',   'Daniel Price',   '',              '', 45933.416667),
          ('Emergency Lighting Test', 45934.0,'Redfern & Co',        '3 Market Street, York',                        'YO1 7ND', 'admin@redfernco.co.uk',             '01904 555 7788','C005', 'CN1005', 'Quarterly functional test',         '3-hour drain test completed on all emergency fittings','One failed battery pack replaced','N/A',  'Oliver Scott',  'Sophie Adams',   '',              '', 45934.645833),
          ('Plumbing Repair',    45935.0, 'Bluebell Interiors',      '27 High Street, Bath',                         'BA1 1AB', 'design@bluebellinteriors.co.uk',    '01225 555 1122','C006', 'CN1006', 'Blocked drain in staff kitchen',    'High-pressure jetting to clear blockage',            'None',                      'N/A',      'George White',  'Amelia Clarke',  '',              '', 45935.458333),
          ('Network Fault Finding',45936.0,'Forge Digital',          'Studio 9, TechHub, Birmingham',                'B1 1AA',  'team@forgedigital.co.uk',           '0121 555 9988', 'C007', 'CN1007', 'Intermittent network connection',   'Re-terminated faulty network port at desk 4',        'None',                      'N/A',      'Liam Turner',   'Grace Mitchell', '',              '', 45936.406250),
          ('AC Service',         45937.0, 'Hawthorn Engineering',    'Unit 12, Mill Lane, Sheffield',                'S1 4GH',  'info@hawthorneng.co.uk',            '0114 555 6677', 'C008', 'CN1008', 'Annual maintenance',                'Cleaned filters and checked refrigerant levels',     'None',                      'N/A',      'Nathan Brooks', 'Chloe Davies',   '',              '', 45937.583333),
          ('Socket Replacement', 45938.0, 'Silverline Finance',      'Suite 5, 100 Queen Street, Glasgow',           'G1 3DN',  'enquiries@silverlinefinance.co.uk', '0141 555 2233', 'C009', 'CN1009', 'Cracked socket faceplate',          'Replaced double socket with new unit',               'None',                      'N/A',      'Ben Foster',    'Isla Morgan',    '',              '', 45938.510417),
          ('Fire Alarm Panel Check',45939.0,'Maple Grove Estates',   '2 The Crescent, Nottingham',                   'NG1 5LP', 'sales@maplegrove.co.uk',            '0115 555 3344', 'C010', 'CN1010', 'Weekly test',                       'Tested call points and panel functions',              'None',                      'N/A',      'Ethan Hall',    'Lily James',     '',              '', 45939.375000),
          ('Boiler Repair',      45940.0, 'Crimson Pixel Ltd',       'Flat 3, 18 Camden Road, London',               'NW1 9LP', 'studio@crimsonpixel.co.uk',         '020 7946 1234', 'C011', 'CN1011', 'No heating or hot water',           'Replaced faulty pump and bled system',               'Advised system flush',      'Plumbing', 'Jack Evans',    'Freya Robinson', '',              '', 45940.687500),
          ('Electrical Installation',45941.0,'Beacon Analytics',     'Suite 10, Innovation Park, Edinburgh',         'EH3 9AB', 'data@beaconanalytics.co.uk',        '0131 555 7788', 'C012', 'CN1012', 'New external lighting',             'Installed 2x LED floodlights with PIR sensor',       'None',                      'N/A',      'Harry Walker',  'Ella Hughes',    '',              '', 45941.541667),
          ('Fuse Box Tripping',  45942.0, 'Willow HR Services',      'Office 2, 5 Station Road, Reading',            'RG1 1AA', 'hr@willowservices.co.uk',           '0118 555 8899', 'C013', 'CN1013', 'Main breaker trips intermittently', 'Identified and replaced faulty circuit breaker (MCB)','None',                      'N/A',      'Oscar Reed',    'Mia Palmer',     '',              '', 45942.489583),
          ('CCTV Camera Adjustment',45943.0,'Ironclad Security Ltd', 'Unit 7, Forge Business Park, Newcastle',       'NE1 4ST', 'secure@ironclad.co.uk',             '0191 555 1122', 'C014', 'CN1014', 'Camera view obstructed',            'Repositioned camera 3 and cleaned lens',             'None',                      'N/A',      'Leo Chapman',   'Charlotte Webb', '',              '', 45943.430556),
          ('Water Heater Repair',45944.0, 'Aurora Events',           'The Loft, 22 Market Place, Oxford',            'OX1 3DU', 'events@aurora.co.uk',               '01865 555 6677','C015', 'CN1015', 'No hot water in kitchenette',       'Replaced failed heating element in water heater',    'None',                      'N/A',      'Jacob Knight',  'Evie Russell',   '',              '', 45944.500000);

          INSERT INTO jobs_expenses (exid, jobno, exdate, exdetails, excost, lastchanged) VALUES
          (1,  1,  45930.0, 'Replacement fuse',        45.00, 45930.406250),
          (2,  2,  45931.0, 'Travel costs',            20.00, 45931.604167),
          (3,  3,  45932.0, 'Pipe sealant',            12.50, 45932.500000),
          (4,  4,  45933.0, 'PAT Testing Labels Roll', 15.50, 45933.437500),
          (5,  5,  45934.0, 'Sunday Parking Surcharge', 8.50, 45934.666667),
          (6,  6,  45935.0, 'Drain Clearing Fluid',    18.99, 45935.479167),
          (7,  7,  45936.0, 'City Centre Parking',     22.00, 45936.423611),
          (8,  8,  45937.0, 'Cleaning Solvents',       12.75, 45937.604167),
          (9,  9,  45938.0, 'Parking Meter',            6.40, 45938.531250),
          (10, 10, 45939.0, 'Travel Mileage (Zone B)', 14.20, 45939.395833),
          (11, 11, 45940.0, 'Congestion Charge',       15.00, 45940.708333),
          (12, 12, 45941.0, 'Exterior Sealant',         9.95, 45941.562500),
          (13, 13, 45942.0, 'Small Parts Consumables',  5.00, 45942.500000),
          (14, 14, 45943.0, 'Secure Parking',          11.50, 45943.447917),
          (15, 15, 45944.0, 'Pipe Joint Compound',      8.25, 45944.520833);

          INSERT INTO jobs_spareparts (spid, jobno, partdetails, qtyused, lastchanged) VALUES
          (1,  1,  'Fuse 13A',                           2,  45930.409722),
          (2,  2,  'Circuit breaker unit',               1,  45931.611111),
          (3,  3,  'Copper pipe 15mm',                   2,  45932.506944),
          (4,  4,  '13A Plug Fuses',                     12, 45933.440972),
          (5,  5,  'Emergency Battery Pack 4.8V',        1,  45934.673611),
          (6,  6,  '40mm Waste Pipe Coupling',           1,  45935.486111),
          (7,  7,  'CAT6 RJ45 Module',                   1,  45936.430556),
          (8,  8,  'AC Air Filter 20x20',                2,  45937.611111),
          (9,  9,  'Double Socket Faceplate (White)',     1,  45938.534722),
          (10, 10, 'Call Point Test Key',                1,  45939.398611),
          (11, 11, 'Grundfos 15-50 Central Heating Pump',1,  45940.713889),
          (12, 12, '30W LED Floodlight IP65',            2,  45941.569444),
          (13, 13, '32A MCB Type B',                     1,  45942.506944),
          (14, 14, 'Lens Cleaning Cloth (Microfibre)',   1,  45943.451389),
          (15, 15, 'Immersion Heater Element 3kW',       1,  45944.527778);

          INSERT INTO jobs_timerecords
          (trid, jobno, logdate, traveltime, timearrived, timedeparted, timetotal, jobtimeseconds, traveltimeseconds, totaltimeseconds, mileage, lastchanged)
          VALUES
          -- traveltime/timearrived/timedeparted/timetotal stored as time-of-day fractions (0.0–1.0)
          (1,  1,  45930.0, 0.020833, 0.375000, 0.416667, 0.041667, 3600,  1800,  5400,  12, 45930.420139),
          (2,  2,  45931.0, 0.031250, 0.562500, 0.625000, 0.062500, 5400,  2700,  8100,  20, 45931.631944),
          (3,  3,  45932.0, 0.013889, 0.479167, 0.520833, 0.041667, 3600,  1200,  4800,  8,  45932.524306),
          (4,  4,  45933.0, 0.027778, 0.354167, 0.520833, 0.194444, 14400, 2400,  16800, 22, 45933.524306),
          (5,  5,  45934.0, 0.017361, 0.583333, 0.645833, 0.079861, 5400,  1500,  6900,  12, 45934.648611),
          (6,  6,  45935.0, 0.034722, 0.395833, 0.458333, 0.097222, 5400,  3000,  8400,  35, 45935.462500),
          (7,  7,  45936.0, 0.020833, 0.364583, 0.406250, 0.062500, 3600,  1800,  5400,  18, 45936.409722),
          (8,  8,  45937.0, 0.010417, 0.541667, 0.583333, 0.052083, 3600,  900,   4500,  8,  45937.587500),
          (9,  9,  45938.0, 0.031250, 0.479167, 0.510417, 0.062500, 2700,  2700,  5400,  28, 45938.513889),
          (10, 10, 45939.0, 0.013889, 0.354167, 0.375000, 0.034722, 1800,  1200,  3000,  10, 45939.378472),
          (11, 11, 45940.0, 0.048611, 0.625000, 0.687500, 0.111111, 5400,  4200,  9600,  45, 45940.690972),
          (12, 12, 45941.0, 0.024306, 0.458333, 0.541667, 0.107639, 7200,  2100,  9300,  20, 45941.545139),
          (13, 13, 45942.0, 0.038194, 0.427083, 0.489583, 0.100694, 5400,  3300,  8700,  32, 45942.493056),
          (14, 14, 45943.0, 0.017361, 0.395833, 0.430556, 0.052083, 3000,  1500,  4500,  14, 45943.434028),
          (15, 15, 45944.0, 0.027778, 0.458333, 0.500000, 0.069444, 3600,  2400,  6000,  25, 45944.504167);
